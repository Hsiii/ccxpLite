  ...
  namespace.sharedConstants = {
    ...
    SIDEBAR_CATEGORIES: [
      ...
      },
      {
        ...
        fallbackLabel: "畢業與口試",
        icon: "graduation-cap",
        itemLabels: ["畢業口試申請", "口試委員成績", "畢業離校查詢"],
      },
      {
        id: "payments-and-aid",
        ...
        fallbackLabel: "繳費與補助",
        icon: "wallet-cards",
        itemLabels: ["學雜(分)費繳費單列印", "獎助學金資訊", "就學貸款"],
      },
      {
        id: "housing-and-life",
      ...
      },
      {
        ...
        fallbackLabel: "表單系統",
        icon: "file-text",
        itemLabels: ["表單簽核系統", "證明文件申請", "成績單申請"],
      },
      {
        id: "campus-systems",
        ...
        fallbackLabel: "校園系統",
        icon: "building-2",
        itemLabels: ["校園巴士資訊", "圖書館系統", "Moodle"],
      },
      {
