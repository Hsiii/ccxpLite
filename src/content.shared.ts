(function registerCcxpLiteShared(globalScope) {
  ...
  const TOKENS = {
    ...
    colorBg: "#f7f7f5",
    colorSurface: "#ffffff",
    colorSidebarSurface: "#f7f7f5",
    colorSurfaceMuted: "#f1f1ee",
    colorBorder: "rgba(31, 41, 51, 0.12)",
    colorSidebarDivider: "rgba(31, 41, 51, 0.12)",
    colorSidebarSearchSurface: "#ffffff",
    colorSidebarSearchGradientStart: "#ffffff",
    colorSidebarSearchBorder: "rgba(31, 41, 51, 0.1)",
    colorPrimaryFocusBorder: "rgba(79, 43, 76, 0.24)",
    colorPrimaryFocusRing: "rgba(79, 43, 76, 0.08)",
    colorPrimaryHoverSurface: "rgba(79, 43, 76, 0.06)",
    colorPrimaryMutedSurface: "rgba(79, 43, 76, 0.04)",
    colorPrimaryGlow: "rgba(79, 43, 76, 0.12)",
    colorSidebarSearchPlaceholder: "#72757e",
    colorText: "#111827",
  ...
  const LOCALIZED_STRINGS = {
    en: {
      ...
      sidebarBreadcrumbHome: "All functions",
      sidebarBack: "Back",
